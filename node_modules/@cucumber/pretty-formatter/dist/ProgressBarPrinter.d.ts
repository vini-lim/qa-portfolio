 ...
 */
export declare class ProgressBarPrinter {
    private readonly stream;
    private readonly options;
    private readonly query;
    private readonly printedProblems;
    private readonly pendingProblems;
    private phase;
    private finishedScenarios;
    private finishedSteps;
    private runningScenarios;
    ...
    private handleUndefinedParameterType;
    private handleTestRunStarted;
    private handleTestCase;
    private handleTestRunHookFinished;
    private handleTestCaseStarted;
    private handleTestStepFinished;
    private handleTestCaseFinished;
